	...
	<div class="row">
	   	<div class="col-sm-12">
	      	<div class="white-box">
				...
				<form class="form-horizontal" method="POST" action='{{ URL("banners/".$banner->id."/edit") }}'>
					@csrf 

					<div class="form-group">
					    <label class="control-label col-sm-3" for="order">Order:</label>
					    <div class="col-sm-9">
					      	<input type="number" class="form-control" name="order" id="order" value="{{ $banner->urut}}">
					    </div>
					</div>
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-9">
					      	<textarea name="deskripsi" rows="5" class="form-control">{{ $banner->descripsi}}</textarea>
					    </div>
					</div>
					...
					<div class="form-group">
					    <label class="control-label col-sm-3">Image Before :</label>
					    <div class="col-sm-9">
					    	<img height="400px" src="{{$banner->image}}">
					    	<input type="hidden" name="image_before" value="{{$banner->image}}">
					    </div>
					</div>
