	...
	<div class="row">
	   	<div class="col-sm-12">
	      	<div class="white-box">
				...
				<form class="form-horizontal" method="POST" action="{{ URL("bank/".$bank->id."/edit") }}">
					@csrf 
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-5">
							<input type="text" class="form-control" name="name" id="name" value="{{ $bank->nama }}" >
					    </div>
					</div>
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-5">
							<input type="text" class="form-control" name="owner" id="owner" value="{{ $bank->owner }}">
					    </div>
					</div>
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-5">
							<input type="text" class="form-control" name="no_rekening" id="no_rekening" value="{{ $bank->no_rekening }}">
					    </div>
					</div>
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-5">
					    	<img src="{{ $bank->image }}">
					    	<input type="hidden" name="old_image" value="{{ $bank->image }}">
					    </div>
					</div>
