	   	...
	   	<div class="col-sm-12">
	      	<div class="white-box">
				...
				<div class="table-responsive">				
					<table class="table color-table info-table" id="transaction-table">
				        <thead>
				            <tr>
				                <th>No</th>
	...
	<script>
		...
		function change()
		{
			$(".change").click(function(){
				...
				.then((willDelete) => {
				  	if (willDelete) {
				    	document.location = "{{ URL('transaction/change') }}/"+id+"/"+type;
				  	} else {
		...
		var table = $('#transaction-table').DataTable({
	        ...
	        columns: [
	            ...
	            { data: 'shipping_fee', name: 'shipping' },
	            { data: 'adminfee', name: 'admin_fee' },
