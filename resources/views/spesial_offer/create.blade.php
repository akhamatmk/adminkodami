	...
	<div class="row">
	   	<div class="col-sm-12">
	      	<div class="white-box">
				...
				<form class="form-horizontal" method="POST" action="{{ URL("specialoffer") }}">
					@csrf 							
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-9">
					    	<textarea name="long_description" class="form-control wysy" rows="4"></textarea>
					    </div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
					    	<input type="number" name="save_money" class="form-control">
					    </div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
					    	<input type="text" name="valid_until" id="expired_time"  class="form-control date">
					    </div>
					</div>
