                  ...
                  <li>
                     ...
                     <span class="fa arrow"></span><span class="label label-rouded label-inverse pull-right">4</span></span></a>
                     <ul class="nav nav-second-level">
                        <li> <a href="{{ URL('transaction') }}"><i class=" fa-fw"></i><span class="hide-menu">Barang</span></a> </li>
                        <li> <a href="{{ URL('transaction/saldo') }}"><i class=" fa-fw"></i><span class="hide-menu">Top Up Saldo</span></a> </li>
                     </ul>
                  </li>
