	...
	<div class="row bg-title">
       ...
       <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<button class="right-side-toggle waves-effect waves-light btn-info btn-circle pull-right m-l-20"><i class="ti-settings text-white"></i></button>
				<a href="{{ URL('our-product') }}" class="btn btn-success btn-sm pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light" target="_top"> <i class="fa fa-back"></i> BACK Product Selection</a>
				<ol class="breadcrumb">
	...
	<div class="row">
	   	<div class="col-sm-12">
	      	<div class="white-box">
				...
				<form class="form-horizontal" method="POST" action='{{ URL("our-product/".$our->id."/edit") }}'>
					@csrf 
					    ...
					    <div class="col-sm-5">
					    	<select class="form-control" name="product" id="product">
					    		@foreach($product as $key => $value)
					    			...
					    			@if($value->id == $our->kodami_product_id)
					    				@php
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-5">
					    	<img src="{{ $our->image }}">
					    	<input type="hidden" name="old_image" value="{{ $our->image }}">
					    </div>
					</div>
